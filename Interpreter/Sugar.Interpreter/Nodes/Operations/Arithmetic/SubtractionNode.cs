...
{
    internal sealed class SubtractionNode : OperatorNode
    {
        public SubtractionNode(IValueNode _a, IValueNode _b) : base(_a, _b)
        {
        ...
        public override string ToString() => "Subtraction Node";
    }
}