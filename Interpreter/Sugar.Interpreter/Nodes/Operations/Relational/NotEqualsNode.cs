...
{
    internal sealed class NotEqualsNode : OperatorNode
    {
        public NotEqualsNode(IValueNode _a, IValueNode _b) : base(_a, _b)
        {
        ...
        public override string ToString() => "Not Equals Node";
    }
}