...
function ChatUi() {
  ...
  return (
    <>
      <div className={`chatContainer`}style={{clipPath: isClipped
      ? 'circle(3% at 93% 0%)' 
      : 'circle(100% at 50% 50%)'}} >
        <h1 style={{ textAlign: 'center',color:'white',position:'absolute',top:'10px',left:'50%',transform:'translateX(-50%)',zIndex:'990' }}>Chat with AI</h1>
